...
「`工單-`」開頭的檔案、`協作指南-給豐兆.md`、`參考-官方事實與已查證資料.md`、`AGENTS.md`、`CLAUDE.md` 都是**教材製作紀錄**——兩位講師與 AI 協作蓋這個站的過程檔，8/19 也會拿它當「AI 協作真實案例」展示。當幕後花絮看可以，跟你要做的三樣東西無關，**整批刪掉完全不影響課程**；要把自己的資料夾推上 GitHub 時，也不必帶著它們。
